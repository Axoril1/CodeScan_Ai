    ...
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem' }}>
      ...
      <div className="dragon-border" style={{
        ...
        <div style={{ paddingLeft: '1rem' }}>
          <h2 style={{ fontFamily: "'Cinzel', serif", fontSize: '1.3rem', fontWeight: 900, color: '#ffe066', letterSpacing: '1px', textShadow: '0 0 10px rgba(255,200,50,0.3)' }}>
            📜 The Ancient Scrolls
          </h2>
          <p style={{ fontSize: '0.85rem', color: '#c8860a', fontWeight: 700, marginTop: '4px' }}>
        ...
        <div key={scan._id} className="dragon-border" style={{ background: '#0d0500', marginBottom: '1rem', overflow: 'hidden' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <span style={{ color: '#c8860a', fontWeight: 800 }}>{expanded === scan._id ? '▲' : '▼'}</span>
            </div>
          </div>
          ...
          {expanded === scan._id && (
            <div style={{ padding: '1.25rem' }} className="fade-in">
              ...
              <div style={{ marginBottom: '1rem' }}>
                <h4 style={{ fontSize: '0.72rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '1px', color: '#c8380a', marginBottom: '0.5rem' }}>⚡ Bugs</h4>
                {scan.result.bugs.length === 0 ? (
                  <div style={{ borderLeft: '3px solid #00a650', padding: '8px 12px', background: 'rgba(0,166,80,0.08)', color: '#50d080', fontSize: '0.85rem', fontWeight: 700 }}>✅ No bugs! Skadoosh!</div>
              ...
              <div style={{ marginBottom: '1rem' }}>
                <h4 style={{ fontSize: '0.72rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '1px', color: '#00a650', marginBottom: '0.5rem' }}>🎋 Master Shifu's Suggestions</h4>
              ...
              <div>
                <h4 style={{ fontSize: '0.72rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '1px', color: '#8b6020', marginBottom: '0.5rem' }}>📜 The Scroll</h4>
